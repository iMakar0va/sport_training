...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO workouts (user_id, type, duration, calories, date)
              VALUES ($1, $2, $3, $4, $5)";
...
<body>
    <div class="container">
        <header>
            ...
            <p>Заполни форму для добавления тренировки</p>
            <a href="dashboard.php"><button type="submit" class="btn">Назад к панели</button></a>
        </header>
        <section class="form-container">
            <form id="workoutForm" action="add_workout.php" method="POST">
